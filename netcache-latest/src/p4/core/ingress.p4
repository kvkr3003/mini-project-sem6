...
control MyIngress(inout headers hdr,
	...
	action noaction0()
	{
		meta.bl_value= meta.bl_value + 44;
		NoAction();
	}
	
	action noaction1()
	{
		meta.bl_value= meta.bl_value + 38;
		NoAction();
	}

	action noaction2()
	{
		meta.bl_value= meta.bl_value + 32;
		NoAction();
	}

	action noaction3()
	{
		meta.bl_value= meta.bl_value + 26;
		NoAction();
	}

	action noaction4()
	{
		meta.bl_value= meta.bl_value + 20;
		NoAction();
	}

	action noaction5()
	{
		meta.bl_value= meta.bl_value + 14;
		NoAction();
	}

	action noaction6()
	{
		meta.bl_value= meta.bl_value + 8;
		NoAction();
	}

	action noaction7()
	{
		meta.bl_value= meta.bl_value + 2;
		NoAction();
	}
	...
	apply {
		...
		if (hdr.netcache.isValid()) 
		{
            ...
            switch(lookup_table.apply().action_run) {
				...
				set_lookup_metadata: 
				{
                    ...
                    if (hdr.netcache.op == READ_QUERY)
                    {
						...
						*/
						...
						{
							meta.bl_value = meta.bl_value + 50;
						}
                    ...
                    {
                    	meta.bl_value= meta.bl_value + 52;
                    	if (hdr.netcache.op == WRITE_QUERY) 
	                    {
	                		meta.bl_value= meta.bl_value + 516;
						...
						else
						{
							...
							if (hdr.netcache.op == UPDATE_COMPLETE) 
							{
								...
								{
									meta.bl_value= meta.bl_value + 256;
								}
								...
								{
									meta.bl_value= meta.bl_value + 128;
								}
								...
								{
									meta.bl_value= meta.bl_value + 64;
								}
								...
								{
									meta.bl_value = meta.bl_value + 16;
								}
							...
							{
								meta.bl_value= meta.bl_value + 512;
							}
				...
				NoAction: {
					meta.bl_value= meta.bl_value + 570;
        ...
        {
        	meta.bl_value= meta.bl_value + 576;
        }
        debug.apply();
